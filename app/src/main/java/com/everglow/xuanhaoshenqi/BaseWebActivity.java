...
//                    "document.getElementsByTagName('logo')[0].style.display='none'; " +
                    "document.getElementsByClassName('header clear')[0].style.display='none'; " +
                    "document.getElementsByClassName('footer')[0].style.display='none'; " +
                    "document.getElementsByClassName('title')[0].style.display='none'; " +
             
                    "document.getElementsByClassName('topnav')[0].style.display='none'; " +
                    "document.getElementsByClassName('page-box clear')[0].style.display='none'; " +
                    "document.getElementsByClassName('bz-bottom')[0].style.display='none'; " +
                    "document.getElementsByClassName('bz-bottom')[1].style.display='none'; " +
            ...
            String javascript1 = "javascript:(function() { " +
                    "document.getElementsByClassName('zx-title')[0].style.display='none'; " +
